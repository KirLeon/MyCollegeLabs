...
public abstract class Stone implements Jewelry{
    ...
    Stone(int price, int weight, double shine, String name, String group) {
    ...
    void increaseWeight() throws IOException {
    ...
    void decreaseShine() throws IOException {
    ...
    void increaseShine() throws IOException {
